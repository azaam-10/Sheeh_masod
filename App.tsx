    ...
    <div className="animate-fade-in-up">
      <section className="relative min-h-[95vh] flex items-center pt-20 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img 
            src="https://images.unsplash.com/photo-1516733968668-dbdce39c46ef?q=80&w=2000" 
            alt="Hero" 
            className="w-full h-full object-cover opacity-60"
          />
          <div className={`absolute inset-0 ${isDarkMode ? 'bg-gradient-to-b from-slate-900/40 via-slate-900/80 to-slate-900' : 'bg-gradient-to-b from-slate-50/40 via-slate-50/80 to-slate-50'}`}></div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            <div className="lg:w-1/2 relative">
               <div className="grid grid-cols-2 gap-4">
                  <img src="https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?q=80&w=800" className="rounded-2xl shadow-lg h-64 w-full object-cover" alt="Detail 1" />
                  <img src="https://images.unsplash.com/photo-1542810634-71277d95dcbb?q=80&w=800" className="rounded-2xl shadow-lg mt-8 h-64 w-full object-cover" alt="Detail 2" />
               </div>
            </div>
...
const AboutView: React.FC = () => (
  <div className="container mx-auto px-4 py-16 animate-fade-in-up">
    <div className="max-w-4xl mx-auto text-center">
      ...
      <img 
        src="https://images.unsplash.com/photo-1524062734617-c881cd095e7b?q=80&w=1200" 
...
const WhereView: React.FC = () => (
  <div className="container mx-auto px-4 py-16 text-center animate-fade-in-up">
    <h1 className="text-4xl font-black mb-12">أين تذهب التبرعات؟</h1>
    <div className="max-w-2xl mx-auto bg-white p-10 rounded-[3rem] shadow-xl border border-slate-100 mb-12">
      <ImpactChart />
    </div>
